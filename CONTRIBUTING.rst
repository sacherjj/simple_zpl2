...
Simple ZPL2 could always use more documentation, whether as part of the
official Simple ZPL2 docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.3, 3.4, 3.5, 3.6 and for PyPy. Check
   https://travis-ci.org/sacherjj/simple_zpl2/pull_requests
